...
type ReportRequest struct {
	...
	OrderBy           []string   `protobuf:"bytes,9,rep,name=order_by,json=orderBy" json:"order_by,omitempty"`
	Type              ReportType `protobuf:"varint,10,opt,name=type,enum=customer.ReportType" json:"type,omitempty"`
}
...
// If you require that the bid request should contains the non empty value in the exact field, use the '"include": false' flag with the empty 'list' array in the ListMatch targeting.
// Example: '"domain": {"include": false}' will target the only requests with the non empty 'site.page' field.
...
var fileDescriptor0 = []byte{
	...
	,
}
