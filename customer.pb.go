...
type Native_Asset struct {
	...
	//	*Native_Asset_Title_
	//	*Native_Asset_Image_
	Type isNative_Asset_Type `protobuf_oneof:"type"`
}
...
type isNative_Asset_Type interface {
	isNative_Asset_Type()
}

type Native_Asset_Title_ struct {
	Title *Native_Asset_Title `protobuf:"bytes,1,opt,name=title,oneof"`
}
type Native_Asset_Image_ struct {
	Image *Native_Asset_Image `protobuf:"bytes,2,opt,name=image,oneof"`
}

func (*Native_Asset_Title_) isNative_Asset_Type() {}
func (*Native_Asset_Image_) isNative_Asset_Type() {}

func (m *Native_Asset) GetType() isNative_Asset_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (m *Native_Asset) GetTitle() *Native_Asset_Title {
	if x, ok := m.GetType().(*Native_Asset_Title_); ok {
		return x.Title
	}
	return nil
}
...
func (m *Native_Asset) GetImage() *Native_Asset_Image {
	if x, ok := m.GetType().(*Native_Asset_Image_); ok {
		return x.Image
	}
	return nil
}
...
func (*Native_Asset) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Native_Asset_OneofMarshaler, _Native_Asset_OneofUnmarshaler, _Native_Asset_OneofSizer, []interface{}{
		(*Native_Asset_Title_)(nil),
		(*Native_Asset_Image_)(nil),
	}
}

func _Native_Asset_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Native_Asset)
	// type
	switch x := m.Type.(type) {
	case *Native_Asset_Title_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Title); err != nil {
			return err
		}
	case *Native_Asset_Image_:
	...
	case nil:
	default:
		return fmt.Errorf("Native_Asset.Type has unexpected type %T", x)
	}
	return nil
}

func _Native_Asset_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Native_Asset)
	switch tag {
	case 1: // type.title
		...
		msg := new(Native_Asset_Title)
		err := b.DecodeMessage(msg)
		m.Type = &Native_Asset_Title_{msg}
		return true, err
	case 2: // type.image
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Native_Asset_Image)
		err := b.DecodeMessage(msg)
		m.Type = &Native_Asset_Image_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Native_Asset_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Native_Asset)
	// type
	switch x := m.Type.(type) {
	case *Native_Asset_Title_:
...
var fileDescriptor0 = []byte{
	...
	,
}
